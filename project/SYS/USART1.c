...
void USART1_Configuration(void)
{
  ...
  GPIO_PullResistorConfig(HT_GPIOC, GPIO_PIN_0, GPIO_PR_UP);  //Turn on UxART Rx internal pull up resistor to prevent unknow state

  AFIO_GPxConfig(GPIO_PB, AFIO_PIN_15, AFIO_FUN_USART_UART);  // Config AFIO mode
  AFIO_GPxConfig(GPIO_PC, AFIO_PIN_0, AFIO_FUN_USART_UART);  // Config AFIO mode
