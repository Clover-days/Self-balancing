...
/* Settings ------------------------------------------------------------------------------------------------*/
#define EEPROM_EMU_SEQUENTIAL_ADDR                (0)  /* Sequential address can only use address like (0, 1, 2 ,3...), non sequential address (20, 24, 30...) is not allowed.  */
...
#define EEPROM_EMU_LENGTH                         (32)  /*!< Length Range: 1 ~ (LIBCFG_FLASH_PAGESIZE / 4 - 2 ). */
