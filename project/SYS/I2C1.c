...
//  I2C_SequentialFilterConfig(HT_I2C1, SEQ_FILTER_2_PCLK);  
  ...
  I2C_SetTimeOutPrescaler(HT_I2C1, 7<<16);  //f(PCLK)/128
  if(I2C1_TIMEOUT_COUNTER > 174)
    I2C_SetTimeOutValue(HT_I2C1, 65535);
  else
    I2C_SetTimeOutValue(HT_I2C1, I2C1_TIMEOUT_COUNTER*375);
  I2C_TimeOutCmd(HT_I2C1, ENABLE);
  I2C_IntConfig(HT_I2C1, I2C_INT_STA | I2C_INT_ADRS | I2C_INT_RXNACK | I2C_INT_BUSERR | I2C_INT_TOUT | I2C_INT_RXDNE | I2C_INT_TXDE, ENABLE);
#else
